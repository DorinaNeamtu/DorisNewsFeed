...
public final class QueryUtils {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                for (int j=0;j<tagArray.length();j++){
                    ...
                    currentAuthor+= new StringBuilder().append(author).append(' ').toString();
                }

                String authors="Author: "+currentAuthor.toString();
                ...
                News newsFeed = new News(title, formattedDate, category, url,authors);
            ...
            Log.e("QueryUtils", "Problem parsing thenews JSON results", e);
        }
    ...
    /**
     * Query and return a list of {@link News} objects.
     */
